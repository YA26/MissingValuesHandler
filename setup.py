...
setup(
  ...
  download_url = 'https://github.com/YA26/Missing_values_handler/archive/v_30.tar.gz',    # I explain this later on
  keywords = ['missing value', 'nan', 'RandomForest'],   # Keywords that define your package best
