...
setup(
  ...
  download_url = 'https://github.com/YA26/Missing_values_handler/archive/v_103.tar.gz',    # I explain this later on
  keywords = ['missing value', 'nan', 'RandomForest', 'MissingValuesHandler'],   # Keywords that define your package best
